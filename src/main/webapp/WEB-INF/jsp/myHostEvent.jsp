...
<form:form method="post" action="/TaskMaster/event/create?fromPage=${fromPage}" commandName="task">
...
<tr><td>Invite your friends:<form:input path="name" required="true"/>
<form:errors class="text-error" path="name" /></td></tr>
</table>
</div>
</form:form>
